...
pub const recordForwardStepBatched = runtime.recordForwardStepBatched;
pub const canBatchPrefill = runtime.canBatchPrefill;
pub const EmbedOverride = runtime.EmbedOverride;
pub const VisionKernels = runtime.VisionKernels;
pub const VisionScratch = runtime.VisionScratch;
pub const recordVisionEmbed = runtime.recordVisionEmbed;
